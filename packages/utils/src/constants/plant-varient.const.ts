import { BiodegradablePlanters, CeramicPlanters, MetalPlanters, PlanterSeries, PlanticPlanters, TerracottaPlanters, WoodenPlanters } from "../enums/planters-series.enum";
...
export const PlanterVariants: PlanterVariantType[] = [
    ...
    // Spring Planter
    {
        ...
        planterSeries: PlanterSeries.terracotta_Planters,
        price: 300,
    ...
    // Blushing Sun Planter
    {
        ...
        planterSeries: PlanterSeries.ceramic_planters,
        price: 600,
        color: { hex: '#ffffff', name: 'white' }
    },
    ...
    // Modern Grace Planter
    {
        ...
        planterSeries: PlanterSeries.plastic_planters,
        price: 250,
    ...
    // Brass Noor Planter
    {
        ...
        planterSeries: PlanterSeries.metal_planters,
        price: 800,
        color: { hex: '#ffffff', name: 'white' }
    },
    ...
    // Gradient Planter
    {
        ...
        planterSeries: PlanterSeries.wooden_planters,
        price: 950,
        color: { hex: '#964B00', name: 'brown' }
    },
    ...
    // Brown Jute Planter
    {
        ...
        planterSeries: PlanterSeries.biodegradable_planters,
        price: 850,
        color: { hex: '#ffffff', name: 'white' }
    },
