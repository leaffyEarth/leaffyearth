...
const EditablePlantImageCarousel = ({ plant, onChange }: { plant: PlantResponseData, onChange: () => void; }) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                />
                {
                    plant?.images?.filter((fruit, index) => {
            ...
            <Stack>
                {selectedImage &&
                    ...
                    >
                        <DeleteImageDialog plantDetails={plant} imageUrl={selectedImage} onCreated={onChange} />
                        {plant.thumbnail !== selectedImage ? <ThumbnailDialog plantDetails={plant} imageUrl={selectedImage} onCreated={onChange} /> : <StarIcon />}
                    </Stack>
                }
                <Box
                    sx={{
