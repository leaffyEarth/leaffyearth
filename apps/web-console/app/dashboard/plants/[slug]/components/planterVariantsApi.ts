...
export const fetchAvailablePlanterVariants = async (): Promise<
...
export const addPlanterVariant = async (
  plantId: string,
  data: CreatePlanterVariant,
): Promise<PlantResponseData> => {
  const response = await api.post(`/plants/${plantId}/planter-variants`, data);
  return response.data;
};

// Delete a planter variant from a plant
export const deletePlanterVariant = async (
  plantId: string,
  planterSku: string,
): Promise<void> => {
...
export const uploadPlanterVariantImage = async (
  plantId: string,
  planterSku: string,
  file: File,
): Promise<void> => {
  ...
  await api.post(
    `/plants/${plantId}/planter-variants/${planterSku}/upload-image`,
    formData,
    {
      headers: {
...
export const updatePlanterVariant = async (
  plantId: string,
  planterSku: string,
  data: UpdatePlanterVariant,
): Promise<void> => {
