...
export default function DeleteImageDialog({ plantDetails, imageUrl, onCreated }: DeletePlantImageDialogProps) {
        ...
        <>
            ...
            <Dialog open={modalOpen} onClose={() => setModalOpen(false)} fullWidth maxWidth="sm">
                <DialogTitle sx={{ m: 0, p: 2 }}>
                    Delete "{plantDetails.name}" Image
                    <IconButton
                        aria-label="close"
                ...
                <DialogContent>
                    Are you sure you want to remove "{imageName}" image
                </DialogContent>
