...
export default function UsersPage() {
    ...
    const handleSelectionChange = (newSelection: GridRowSelectionModel) => {
        ...
        const selectedData = users.filter((user) => newSelection.includes(user._id));
    ...
    return (
        ...
        >
            ...
            <Collapse orientation="vertical" in={selectedRowsData.length > 0} timeout={200} unmountOnExit >
                <Box
                    sx={{
                        display: "flex",
                        height: '70px',
                ...
                >
                    ...
                    {
                        selectedRowsData.length == 1 && <AdminActionMenu selectedRow={selectedRowsData[0]} onCreated={fetchUsers} />
                    }
