...
export enum PlantLightExposureTypeEnum {
  BRIGHT_INDIRECT = "Bright Indirect Light",
  BRIGHT_DIRECT = "Bright Direct Light",
  LOW_LIGHT = "Low Light"
}

export enum PlantIdealLocationTypeEnum {
...
export enum PlantMaintenanceTypeEnum {
  HIGH = "High Maintainance",
  LOW = "Low Maintainance",
  MEDIUM = "Medium Maintainace"
}

export enum PlantWateringTypeEnum {
...
export enum PlantTagsTypeEnum {
  NEW_ARRIVAL = "New Arrivals",
  MOST_POPULAR = "Most Popular",
  TOP_INTERIOR = "Top Indoor"
} 